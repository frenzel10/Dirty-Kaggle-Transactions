...
## Goal
- Wanted to demonstrate data entry and cleaning for financial records. Then use cleaned data to extract insights.

## Tools
- Excel: filtering, sorting, conditional formatting, ranking formulas, pivot tables
